...
@Component({
  selector: 'app-total-calendar',
  templateUrl: './total-calendar.component.html',
  styleUrls: ['./total-calendar.component.scss']
})
export class TotalCalendarComponent implements OnInit {
  account: Account;
  accounts;
  posts;
  user;
